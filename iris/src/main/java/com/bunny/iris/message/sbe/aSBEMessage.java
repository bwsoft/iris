...
public class aSBEMessage extends aSBEGroup {
	...
	public aSBEMessage(SBEMessageSchema schema, SBEMessageHeader header, SBEGroupHeader grpHeader, SBEVarLengthFieldHeader vHeader) {
